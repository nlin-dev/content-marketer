        ...
        {available.map((asset) => (
          <button
            ...
            className={cn(
              ...
              asset.id === selectedId && asset.id !== currentAssetId && 'border-blue-500 bg-blue-50',
              asset.id !== currentAssetId && asset.id !== selectedId && 'border-gray-200 hover:border-gray-300',
            )}
          ...
          >
            {asset.asset_type === 'image' ? (
              ...
              <div className="flex h-20 w-full items-center justify-center rounded bg-gray-100 text-xs text-gray-500">
                {asset.asset_type}
              </div>
            )}
